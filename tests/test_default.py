...
class TestDefaultTag(_unittest.TestCase):
...
class TestPolicyAndLoaderControls(_unittest.TestCase):
    def test_expr_compile_wrap_exceptions_toggle(self) -> None:
        ...
        with self.assertRaises(_ydst.TemplateValidationError):
...
class TestProgrammaticTemplateValidation(_unittest.TestCase):
